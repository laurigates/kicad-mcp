...
class TestPinInfo:
    ...
    def test_connection_point_calculation(self):
        ...
        pin = PinInfo("1", "test", PinDirection.PASSIVE, PinType.ELECTRICAL, 
                     (0, 0), length=2.54, angle=0.0)
...
class TestComponentPin:
    ...
    def test_connection_point_property(self):
        ...
        pin_info = PinInfo("1", "test", PinDirection.PASSIVE, PinType.ELECTRICAL, 
                          (2.54, 0), length=2.54, angle=0.0)
        component_pin = ComponentPin("R1", pin_info, (50.0, 50.0), 0.0)
...
class TestComponentPinMapper:
    ...
    def test_pin_compatibility(self):
        ...
        assert self.mapper.can_connect_pins(r1_pin, led_pin) == True
        
        # Power to passive should work
        assert self.mapper.can_connect_pins(vcc_pin, r1_pin) == True
