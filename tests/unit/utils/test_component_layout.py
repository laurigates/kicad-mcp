...
class TestComponentBounds:
    ...
    def test_overlap_detection(self):
        ...
        assert comp1.overlaps_with(comp2) == True
        assert comp1.overlaps_with(comp3) == False
...
class TestComponentLayoutManager:
    ...
    def test_position_validation(self):
        ...
        # Valid positions
        assert self.layout_manager.validate_position(100, 100, 'resistor') == True
        assert self.layout_manager.validate_position(50, 50, 'resistor') == True
        
        # Invalid positions (outside bounds)
        assert self.layout_manager.validate_position(10, 10, 'resistor') == False  # Too close to edge
        assert self.layout_manager.validate_position(400, 400, 'resistor') == False  # Outside bounds
        assert self.layout_manager.validate_position(290, 100, 'resistor') == False  # Too close to right edge
    ...
    def test_component_placement(self):
        ...
        assert self.layout_manager.validate_position(x, y, 'resistor') == True
